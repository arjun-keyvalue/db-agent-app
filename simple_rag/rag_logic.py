...
class SQLAgent:
    def __init__(self, qdrant_config: Dict, groq_api_key: str):
        ...
        self.collection_name = "northwind_rag"
    ...
    def _execute_sql_query(self, sql_query: str) -> Tuple[List, List]:
        ...
        try:
            ...
            # Return empty results on error to maintain tuple structure
    ...
    def process_query(self, user_query: str) -> Dict:
        ...
        try:
            ...
            schema_context = "\n\n".join([
                ...
                for table in relevant_tables if table.get('table_info')
            ])
            if not schema_context:
                return {
                    ...
                    'results': None,
                    'relevant_tables': None,
                    'error': "Failed to create schema context from relevant tables."
                }
